...
const styles = {
  ...
  buttonContainer: {
    textAlign: "center", // Center-align the button container
    padding: "20px 0", // Add some space above and below the button
  },
  button: {
    width: "90%",
    backgroundColor: "#4F3738", // Dark color for the button background
    ...
    fontWeight: 600, // Make the text a bit bold
